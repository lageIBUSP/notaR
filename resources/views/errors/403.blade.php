...
<div class="container container-main">
    ...
    <div id="sidebar" class="col-md-2">
      ...
      <div id="content" class="col-md-10">
        <h1>Ops!</h1>
        <h3>Seu usuário não tem permissão para isso!</h3>
        <p>Se você está vendo essa página, é porque você está tentando fazer algo que não tem permissão.
            <ol>
                <li>Verifique se você ainda está logado no site.</li>
